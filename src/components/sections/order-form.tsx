...
export function OrderForm() {
  ...
  async function handleSubmit() {
    ...
    // Exactly the five fields of GuestOrderV2RequestDTO — no price, no
                    ...
                    {SERVICES.map((service, index) => {
                      ...
                      return (
                        <div
                          key={service.id}
                          className={cn(
                            "relative min-h-[62px] rounded-xl border px-3.5 py-1.5 transition-all",
                            selected
                        ...
                        >
                          ...
                          <div className="pointer-events-none relative z-20 flex h-full flex-col justify-between">
                            <div className="flex items-start justify-between gap-2">
                              <div>
                                <p className="text-text-primary text-[15px] leading-5 font-semibold">
                                  {service.label}
                                </p>
                            ...
                            <div className="mt-1 flex items-center justify-end">
                              <button
                                ...
                                className="pointer-events-auto relative z-30 inline-flex [touch-action:manipulation] items-center gap-1 text-[11px] font-semibold text-indigo-600 transition hover:text-indigo-800"
                              >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      set("phone", sanitisePhoneInput(e.target.value))
                    }
                    className={cn(
                      inputBase,
