...
// Material "sms" glyph — message bubble, same icon family as the rest
// of the contact bar. Replaces the old handset: this item texts now.
const MESSAGE_PATH =
      ...
      <nav className="site-nav">
        ...
        <div className="nav-topbar">
          <div className="nav-topbar-left">
            <a
              className="nav-top-phone"
              href="sms:+18175071278"
              aria-label="Text +1 (817) 507-1278"
            >
