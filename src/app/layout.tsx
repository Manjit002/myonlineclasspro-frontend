...
import { VpnGuard } from "@/components/security/vpn-guard";
    ...
    >
      ...
      <body className="bg-bg-0 text-text-primary flex min-h-full flex-col">
        ...
        >
          ...
          {/* Renders nothing unless the backend reports a VPN/proxy.
              Mounted last and outside SiteChrome so it covers every
              route — public pages and dashboard alike. */}
          {/* GA4 — mounted once here so home, every service page and the
              rest of the site share a single initialisation. */}
          <GoogleAnalytics />
          <VpnGuard />
        </ThemeProvider>
      </body>
