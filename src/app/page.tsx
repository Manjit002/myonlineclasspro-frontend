...
function SectionHeading({
  ...
  return (
    <div className="mx-auto max-w-3xl text-center">
      ...
      <Reveal delay={0.06}>
        <h2 className="font-display text-text-primary mt-5 text-3xl tracking-wide sm:text-4xl lg:text-5xl">
...
export default function Home() {
  return (
    <>
      {/* ── Hero + order panel ── */}
      <section className="mx-auto grid max-w-7xl items-start gap-12 px-4 pt-12 pb-14 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8 lg:pt-20">
        <HeroIntro />
      ...
      <section className="border-border bg-bg-1 border-y py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="font-display text-text-primary mb-8 text-center text-2xl tracking-wide sm:text-3xl">
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <Reveal>
          <div className="border-border bg-bg-1 rounded-lg border px-6 py-16 text-center">
            <h2 className="font-display text-text-primary text-3xl tracking-wide sm:text-4xl lg:text-5xl">
