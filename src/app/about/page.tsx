...
export default function AboutPage() {
  return (
    <>
      <PageSchema
        path="/about"
        title={"About Us - Trusted Online Class Help | MyOnlineClassPro"}
        description={
        ...
        <section className="mx-auto w-full max-w-3xl px-4 py-16 text-center sm:px-6 lg:px-8">
          ...
          <Reveal delay={0.08}>
            <p className="text-text-secondary mx-auto mt-5 max-w-2xl text-base leading-relaxed">
              {SITE.name} exists to take the pressure off students juggling
              online coursework alongside work and life. We pair you with a
              verified academic expert in your subject, keep you updated
              throughout, and stand behind the outcome.
            </p>
          </Reveal>
        </section>
