/**
 * ISO country list with international dialing codes.
 *
 * Flags are derived from the ISO code as regional-indicator symbols, so
 * there are no image assets to load or keep in sync.
 */
...
/** Regional-indicator pair for the two-letter ISO code. */
