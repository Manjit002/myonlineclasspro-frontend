 ...
 * downloaded and re-hosted under img.myonlineclasspro.com/photos before
...
export const UNIVERSITY_LOGOS: ImageAsset[] = [
  ...
  {
    src: "https://img.myonlineclasspro.com/photos/DeVry_University_Logo.png",
...
export const GRADE_SCREENSHOTS: ImageAsset[] = GRADE_ALTS.map((pct, i) => ({
  src: `https://img.myonlineclasspro.com/photos/Grade${i + 1}.png`,
